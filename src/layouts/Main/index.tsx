...
const Layout:React.FC<props> = ({children1,children2,text="or",hr=true}) => {
  return (
        <main className="bg-gradient-to-b  min-h-screen py-10 flex flex-col  space-y-10 overflow-x-hidden justify-start items-center w-screen  bg-bg_pink drop-shadow-2xl">
            {children1}
